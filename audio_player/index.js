...
let speed_a = document.querySelectorAll('.speed-dropdown a');



console.log(speed_a);
speed_a.forEach(element =>{
    element.addEventListener('click',()=>{
        audio.playbackRate = element.textContent;
        if (element.textContent != 1){
        document.getElementById('speed-text').textContent = element.textContent + "x";
